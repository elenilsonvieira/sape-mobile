...
import { FlatList, Button, StyleSheet, Alert, useColorScheme, TouchableOpacity } from 'react-native';
    ...
    const handleSaveActivity = async (newActivity: IActivity) => {
        if(editActivity){
            try {
                ...
                await AsyncStorage.setItem("@SapeApp:activities", JSON.stringify(updtActivity));
            ...
            try {
                await AsyncStorage.setItem("@SapeApp:activities", JSON.stringify(updatedActivities));
